...
/// 잘게 진동해 읽을 수가 없다.
///
/// 8°에서 5°로 내렸다(2026-08-24) — 이 값은 **회전이 시작되기까지의 지연**이기도
/// 하다. 몸을 8° 틀 때까지 화면이 가만히 있으면 그만큼 늦게 따라오는 것으로
/// 보인다. 흔들림을 지우는 몫이 프레임 보간으로 옮겨 갔으므로 그만큼 좁혔다.
const followCameraBearingDeadbandDeg = 5.0;
